 ...
 *
 */
public class DummyApiAiServlet extends DFWebhookServlet<GoogleData> {
	...
	@Override
	protected void doWebhook(DFWebhookRequest request, DFWebhookResponse<GoogleData> response) {
		Random r = new Random();
		if (r.nextBoolean()) {
	 ...
	 * @param response
	 */
	private void replyWithGoogleData(DFWebhookRequest request, DFWebhookResponse<GoogleData> response) {
